...
\begin{definition}
  ...
  \]
\end{definition}
observación. Que $\mu^*(A)\geq \mu^*(A\cap E)+ \mu^*(A\cap E^c) $ vale siempre (por $\sigma$-subaditividad de $\mu^*$). Luego, para ver que $E$ es $\mu^*$-medible, baste ver que $\mu^*(A)\geq \mu^*(A\cap E)+ \mu^*(A\cap E^c)$ 
...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    \item[(2)] La clase $\mathcal{M}_{\mu^*}$ de conjuntos $\mu^*$-medibles es un $\sigma$-álgebra.

    \item[(3)] La restricción $\mu$ de $\mu^*$ a $\mathcal{M}_{\mu^*}$ es una medida.
  \end{enumerate}
  En particular, $(X, \mathcal{M}_{\mu^*}, \mu)$ es un espacio de medida completo. 
\end{theorem}
